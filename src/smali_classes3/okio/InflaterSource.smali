...
.method public final c0(Lokio/Buffer;J)J
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lokio/InflaterSource;->f(Lokio/Buffer;J)J
...
.method public final f(Lokio/Buffer;J)J
    .locals 7
    .param p1    # Lokio/Buffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iget-boolean v5, p0, Lokio/InflaterSource;->d:Z
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p1, v4}, Lokio/Buffer;->W(I)Lokio/Segment;
    ...
    iget-object v4, p0, Lokio/InflaterSource;->a:Lokio/BufferedSource;
    ...
    :cond_2
    :try_start_1
    invoke-interface {v4}, Lokio/BufferedSource;->l()Z
