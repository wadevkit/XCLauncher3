...
.method public static final a(Ljava/util/ArrayList;)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {v3, v0}, Lokio/internal/ZipEntry;-><init>(Lokio/Path;)V
    ...
    invoke-static {v2}, Lkotlin/collections/MapsKt;->g([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/CollectionsKt;->P(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    iget-object v2, v1, Lokio/internal/ZipEntry;->a:Lokio/Path;
    ...
    iget-object v1, v1, Lokio/internal/ZipEntry;->a:Lokio/Path;

    if-eqz v3, :cond_2

    iget-object v2, v3, Lokio/internal/ZipEntry;->h:Ljava/util/ArrayList;
...
.method public static final c(Lokio/RealBufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-virtual/range {p0 .. p0}, Lokio/RealBufferedSource;->Z()I
    ...
    invoke-virtual/range {p0 .. p0}, Lokio/RealBufferedSource;->u()S
    ...
    invoke-virtual {v8, v0, v1}, Lokio/RealBufferedSource;->x(J)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6, v9}, Lkotlin/text/StringsKt;->p(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {v8, v14, v11}, Lokio/internal/ZipFilesKt;->d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {v2, v3}, Lokio/Path;->g(Ljava/lang/String;)Lokio/Path;

    move-result-object v4

    invoke-static {v3, v0, v1}, Lkotlin/text/StringsKt;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->u()S
    ...
    invoke-virtual {p0, v4, v5}, Lokio/RealBufferedSource;->h(J)V
    ...
    invoke-static {p2, p1}, Landroid/car/content/pm/a;->f(Ljava/lang/String;I)Ljava/lang/String;
...
.method public static final e(Lokio/RealBufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    .locals 14
    ...
    iget-object v2, p1, Lokio/FileMetadata;->f:Ljava/lang/Long;
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->Z()I
    ...
    invoke-virtual {p0, v4, v5}, Lokio/RealBufferedSource;->skip(J)V
    ...
    invoke-virtual {p0, v6, v7}, Lokio/RealBufferedSource;->skip(J)V
    ...
    invoke-virtual {p0, v2, v3}, Lokio/RealBufferedSource;->skip(J)V
    ...
    invoke-direct {v1, p0, v0, v2, v3}, Lokio/internal/ZipFilesKt$readOrSkipLocalHeader$1;-><init>(Lokio/RealBufferedSource;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/internal/Ref$ObjectRef;)V

    invoke-static {p0, v4, v1}, Lokio/internal/ZipFilesKt;->d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V

    new-instance p0, Lokio/FileMetadata;

    iget-boolean v6, p1, Lokio/FileMetadata;->a:Z

    iget-boolean v7, p1, Lokio/FileMetadata;->b:Z

    const/4 v8, 0x0

    iget-object v9, p1, Lokio/FileMetadata;->d:Ljava/lang/Long;
