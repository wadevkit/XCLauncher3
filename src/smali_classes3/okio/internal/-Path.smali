...
.method public static final a(Lokio/Path;)I
    ...
    invoke-virtual {p0, v5, v0}, Lokio/ByteString;->j(I[B)I
...
.method public static final b(Lokio/Path;Lokio/Path;Z)Lokio/Path;
    ...
    invoke-virtual {v1, p0}, Lokio/Buffer;->d0(Lokio/ByteString;)V
    ...
    invoke-virtual {v1, v0}, Lokio/Buffer;->d0(Lokio/ByteString;)V
...
.method public static final c(Lokio/Path;)Lokio/ByteString;
    ...
    invoke-static {v0, v1}, Lokio/ByteString;->m(Lokio/ByteString;Lokio/ByteString;)I
    ...
    invoke-static {p0, v1}, Lokio/ByteString;->m(Lokio/ByteString;Lokio/ByteString;)I
...
.method public static final d(Lokio/Buffer;Z)Lokio/Path;
    ...
    invoke-virtual {v0, v6, v7, v5}, Lokio/Buffer;->B(JLokio/ByteString;)Z
    ...
    invoke-virtual {v1, v2}, Lokio/Buffer;->d0(Lokio/ByteString;)V
    ...
    :cond_3
    invoke-virtual {v0, v10}, Lokio/Buffer;->v(Lokio/ByteString;)J
    ...
    :cond_4
    invoke-virtual {v0, v13, v14}, Lokio/Buffer;->D(J)B
    ...
    invoke-virtual {v0, v4, v5}, Lokio/Buffer;->D(J)B
    ...
    :cond_8
    invoke-virtual {v0, v6, v7}, Lokio/Buffer;->D(J)B
    ...
    invoke-virtual {v1, v0, v4, v5}, Lokio/Buffer;->C(Lokio/Buffer;J)V

    goto :goto_8

    :cond_d
    invoke-virtual {v1, v0, v11, v12}, Lokio/Buffer;->C(Lokio/Buffer;J)V
    ...
    invoke-virtual/range {p0 .. p0}, Lokio/Buffer;->I()Lokio/ByteString;
    ...
    :cond_11
    invoke-virtual {v0, v13, v14}, Lokio/Buffer;->j(J)Lokio/ByteString;
    ...
    invoke-static {v5}, Lkotlin/collections/CollectionsKt;->B(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v4}, Lokio/Buffer;->d0(Lokio/ByteString;)V
    ...
    invoke-virtual {v1, v12}, Lokio/Buffer;->d0(Lokio/ByteString;)V
...
.method public static final f(Ljava/lang/String;)Lokio/ByteString;
    ...
    invoke-static {v1, p0}, Landroid/car/content/pm/a;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
