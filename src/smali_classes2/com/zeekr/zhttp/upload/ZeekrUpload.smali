...
.method public applyFileUpload(Ljava/io/File;Lio/reactivex/Observable;Lcom/zeekr/zhttp/upload/interfaces/IUploadListener;)Ljava/lang/Boolean;
    ...
    invoke-virtual/range {v5 .. v10}, Lcom/zeekr/zhttp/upload/FileUploadManager;->c(IJJ)V
    ...
    iput-object v6, v4, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->b:Ljava/lang/Long;

    sget-object v6, Lcom/zeekr/zhttp/upload/FileUploadManager;->i:Ljava/lang/String;

    iput-object v6, v4, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->c:Ljava/lang/String;

    invoke-static {p1}, Lcom/zeekr/zhttp/n0;->b(Ljava/io/File;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v4, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->e:Ljava/lang/String;

    const/4 v6, 0x0

    iput-object v6, v4, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->d:Ljava/lang/String;
    ...
    iput-boolean v2, v6, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->a:Z

    iput v2, v6, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->b:I

    iput-boolean v2, v6, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->c:Z

    iput-object v6, v4, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->f:Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;
    ...
    new-instance v5, Lcom/zeekr/sdk/multidisplay/communication/a;

    invoke-direct {v5, v3, p1, v4, v0}, Lcom/zeekr/sdk/multidisplay/communication/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v0, Lq/b;

    invoke-direct {v0, p1, v4}, Lq/b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {p2, v5, v0}, Lio/reactivex/Observable;->b(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)V
    :try_end_0
...
.method public getRequestBody(Ljava/io/File;Ljava/lang/String;)Lokhttp3/RequestBody;
    ...
    iput-object p2, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->a:Ljava/lang/String;
    ...
    iput-object p2, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->b:Ljava/lang/Long;

    iput-object v0, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->c:Ljava/lang/String;

    invoke-static {p1}, Lcom/zeekr/zhttp/n0;->b(Ljava/io/File;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->e:Ljava/lang/String;

    iput-object v2, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->d:Ljava/lang/String;
    ...
    iput p2, p1, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->b:I

    iput-boolean p2, p1, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->a:Z

    iput-boolean p2, p1, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;->c:Z

    iput-object p1, v3, Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo;->f:Lcom/zeekr/zhttp/upload/bean/ApplyUploadInfo$Acl;

    new-instance p1, Lcom/google/gson/Gson;

    invoke-direct {p1}, Lcom/google/gson/Gson;-><init>()V

    invoke-virtual {p1, v3}, Lcom/google/gson/Gson;->j(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    const-string v0, "get request body  object to json :"

    invoke-static {v0, p1}, Landroid/car/content/pm/a;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    new-array p2, p2, [Ljava/lang/Object;

    invoke-static {v1, v0, p2}, Lcom/zeekr/zhttp/upload/utils/logUtils;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
