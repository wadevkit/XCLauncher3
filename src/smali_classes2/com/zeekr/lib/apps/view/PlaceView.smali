...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/zeekr/lib/apps/view/PlaceView$Companion;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->d:F

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->f:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->g:Landroid/graphics/Path;
    ...
    iput-object p2, p0, Lcom/zeekr/lib/apps/view/PlaceView;->h:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->i:Landroid/graphics/Paint;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/zeekr/lib/apps/view/PlaceView;->f:Landroid/graphics/RectF;

    const/4 v1, 0x0

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->saveLayer(Landroid/graphics/RectF;Landroid/graphics/Paint;)I

    iget-object v1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->g:Landroid/graphics/Path;

    iget-object v2, p0, Lcom/zeekr/lib/apps/view/PlaceView;->h:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->i:Landroid/graphics/Paint;

    const/high16 v2, 0x4d000000    # 1.3421773E8f

    invoke-virtual {v1, v2}, Landroid/graphics/Paint;->setColor(I)V

    iget v2, p0, Lcom/zeekr/lib/apps/view/PlaceView;->d:F
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lcom/zeekr/lib/apps/view/PlaceView;->f:Landroid/graphics/RectF;
    ...
    iget v0, p0, Lcom/zeekr/lib/apps/view/PlaceView;->d:F
    ...
    iget-object p2, p0, Lcom/zeekr/lib/apps/view/PlaceView;->g:Landroid/graphics/Path;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Lcom/zeekr/lib/apps/view/PlaceView;->e:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iput-object p1, p0, Lcom/zeekr/lib/apps/view/PlaceView;->e:Landroid/graphics/drawable/Drawable;
