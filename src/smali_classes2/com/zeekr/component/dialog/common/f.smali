...
.method public synthetic constructor <init>(Lcom/zeekr/component/dialog/ZeekrDialogLayout;Lcom/zeekr/component/dialog/common/ZeekrFullDialog;)V
    ...
    iput-object p2, p0, Lcom/zeekr/component/dialog/common/f;->a:Lcom/zeekr/component/dialog/common/ZeekrFullDialog;

    iput-object p1, p0, Lcom/zeekr/component/dialog/common/f;->b:Landroid/view/View;
...
.method public final onGlobalLayout()V
    ...
    iget-object v1, p0, Lcom/zeekr/component/dialog/common/f;->b:Landroid/view/View;
    ...
    iget-object v3, v0, Lcom/zeekr/component/dialog/common/ZeekrFullDialog;->e:Lcom/zeekr/component/databinding/ZeekrDialogOuterLayoutBinding;
    ...
    invoke-static {v2, v4, v5}, Landroid/car/content/pm/a;->t(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v5, v0, Lcom/zeekr/component/dialog/common/ZeekrFullDialog;->c:I

    const-string v6, "ZeekrDialogInput"

    invoke-static {v2, v5, v6}, Lcoil/disk/a;->y(Ljava/lang/StringBuilder;ILjava/lang/String;)V

    iget v2, v0, Lcom/zeekr/component/dialog/common/ZeekrFullDialog;->c:I
    ...
    :cond_3
    iget-boolean v5, v3, Lcom/zeekr/component/dialog/common/ZeekrDialogOuterLayout;->l:Z

    if-nez v5, :cond_5

    iput-boolean v7, v3, Lcom/zeekr/component/dialog/common/ZeekrDialogOuterLayout;->l:Z
    ...
    iget-boolean v1, v3, Lcom/zeekr/component/dialog/common/ZeekrDialogOuterLayout;->l:Z

    if-eqz v1, :cond_5

    iput-boolean v6, v3, Lcom/zeekr/component/dialog/common/ZeekrDialogOuterLayout;->l:Z
    ...
    :cond_5
    :goto_1
    iput v4, v0, Lcom/zeekr/component/dialog/common/ZeekrFullDialog;->c:I
