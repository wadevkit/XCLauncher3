...
.method public static i(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;ILcom/zeekr/mediawidget/ui/a;)Z
    .locals 1
    .param p0    # Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Lcom/zeekr/mediawidget/ui/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    new-instance p2, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$3;

    invoke-direct {p2, p0, p1}, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$3;-><init>(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;I)V

    new-instance p1, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$4;

    invoke-direct {p1, p0}, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$4;-><init>(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;)V

    invoke-static {p1, p2}, Lcom/zeekr/mediawidget/mediacenter/MediaCenterHelperKt;->a(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;)Z

    move-result p0

    const-string/jumbo p1, "switch mediaSource result:"

    invoke-static {p1, p0}, Lcoil/disk/a;->l(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public static j(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;Lcom/zeekr/mediawidget/ui/a;)Z
    .locals 2
    .param p0    # Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p1    # Lcom/zeekr/mediawidget/ui/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    new-instance p1, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$1;

    invoke-direct {p1, p0}, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$1;-><init>(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;)V

    new-instance v0, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$2;

    invoke-direct {v0, p0}, Lcom/zeekr/mediawidget/repository/MediaCenterRepository$switchMediaSource$result$2;-><init>(Lcom/zeekr/sdk/mediacenter/bean/MediaAppInfo;)V

    invoke-static {v0, p1}, Lcom/zeekr/mediawidget/mediacenter/MediaCenterHelperKt;->a(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;)Z
    ...
    invoke-static {v0, p1, v1}, Lcom/zeekr/mediawidget/utils/LogHelper;->b(ILjava/lang/Object;Ljava/lang/String;)V
...
.method public final b()V
    ...
    invoke-static {v0, v1, v3}, Lcom/zeekr/mediawidget/utils/LogHelper;->b(ILjava/lang/Object;Ljava/lang/String;)V
