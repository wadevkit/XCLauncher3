...
.method public static constructor <clinit>()V
    ...
    const-class v2, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;

    const-string v3, "cardPref"

    const-string v4, "getCardPref()Ljava/lang/String;"
    ...
    sput-object v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->o:[Lkotlin/reflect/KProperty;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->f:Landroidx/lifecycle/MutableLiveData;
    ...
    invoke-direct {v0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$special$$inlined$pref$1;-><init>()V
...
.method public static final a(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 9

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v0, "queryList covertVoToData userId="

    const-string v1, "queryList userId="

    const-string v2, "queryList userId:"

    instance-of v3, p1, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;

    if-eqz v3, :cond_0

    move-object v3, p1

    check-cast v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;

    iget v4, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->h:I
    ...
    iput v4, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->h:I

    goto :goto_0

    :cond_0
    new-instance v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;

    invoke-direct {v3, p0, p1}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p1, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->f:Ljava/lang/Object;

    sget-object v4, Lkotlin/coroutines/intrinsics/CoroutineSingletons;->a:Lkotlin/coroutines/intrinsics/CoroutineSingletons;

    iget v5, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->h:I
    ...
    iget-object p0, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->e:Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;
    ...
    iput-object p0, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->e:Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;

    iput v7, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->h:I

    invoke-virtual {p1, v3}, Lcom/zeekr/scenario/customization/carditem/utils/UserManager;->b(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v8, p0}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput v6, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$queryList$1;->h:I
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->k()Lcom/zeekr/scenarioengine/service/operation/OperationServiceManager;

    move-result-object v2

    invoke-virtual {v2, p1}, Lcom/zeekr/scenarioengine/service/operation/OperationServiceManager;->queryList(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v8, v1}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->d(Ljava/util/List;)Ljava/util/List;
    ...
    const-string p1, ", voList.size:"

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p0, ", voList:"
...
.method public static final b(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Ljava/util/List;ZZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 7

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v0, p4, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;
    ...
    iget v1, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->k:I
    ...
    iput v1, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->k:I
    ...
    invoke-direct {v0, p0, p4}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p4, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->i:Ljava/lang/Object;

    sget-object v1, Lkotlin/coroutines/intrinsics/CoroutineSingletons;->a:Lkotlin/coroutines/intrinsics/CoroutineSingletons;

    iget v2, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->k:I
    ...
    iget-boolean p0, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->g:Z

    iget-object p1, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->e:Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;
    ...
    :cond_2
    iget-boolean p3, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->h:Z

    iget-boolean p2, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->g:Z

    iget-object p1, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->f:Ljava/util/List;
    ...
    const-string/jumbo v6, "updateCardData saveCard:"

    invoke-direct {v2, v6}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v2, p2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v6, ", needUpdateCardData:"

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v6, ", allList.size:"

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p4, ", allList:"
    ...
    invoke-static {v5, p4}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->d(Ljava/lang/String;Ljava/lang/String;)V

    sget-object p4, Lcom/zeekr/scenario/customization/carditem/utils/UserManager;->Companion:Lcom/zeekr/scenario/customization/carditem/utils/UserManager$Companion;

    invoke-virtual {p4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object p4, Lcom/zeekr/scenario/customization/carditem/utils/UserManager;->d:Lcom/zeekr/scenario/customization/carditem/utils/UserManager;
    ...
    iput-object p1, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->f:Ljava/util/List;

    iput-boolean p2, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->g:Z

    iput-boolean p3, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->h:Z

    iput v4, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->k:I

    invoke-virtual {p4, v0}, Lcom/zeekr/scenario/customization/carditem/utils/UserManager;->b(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    const-string/jumbo p0, "updateCardData user not login, update false"

    invoke-static {v5, p0}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p4, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->f:Ljava/util/List;

    iput-boolean p3, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->g:Z

    iput v3, v0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateCardData$1;->k:I

    invoke-virtual {p0, p1, p2, v0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->g(Ljava/util/List;ZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    const-string/jumbo p3, "updateCardData cardItem: "
    ...
    invoke-static {v5, p2}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p1, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->g:Landroidx/lifecycle/MutableLiveData;
    ...
    invoke-static {p4, p2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->e(Ljava/util/List;Ljava/util/List;)Z
    ...
    :cond_7
    iget-object p0, p1, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->g:Landroidx/lifecycle/MutableLiveData;
    ...
    const-string/jumbo p3, "updateCardData emit "
    ...
    :cond_8
    iget-object p0, p1, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->f:Landroidx/lifecycle/MutableLiveData;
...
.method public static final c(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Ljava/util/List;Z)Ljava/lang/Boolean;
    .locals 9
    ...
    const-string/jumbo v2, "updateEditScenariosData allList.size "
    ...
    iget-boolean v7, v7, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->j:Z
    ...
    invoke-static {v2, v3}, Lkotlin/collections/CollectionsKt;->P(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->l()Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;
    ...
    const-string/jumbo v7, "updateEditScenariosData manualList: "
    ...
    invoke-static {v2, p1}, Lkotlin/collections/CollectionsKt;->P(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;

    move-result-object p1

    new-instance v2, Ljava/lang/StringBuilder;

    const-string/jumbo v3, "updateEditScenariosData autoList: "
    ...
    invoke-virtual {p0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->f()Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;
    ...
    invoke-static {v0, p1}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->e(Ljava/util/List;Ljava/util/List;)Z

    move-result p1

    const-string/jumbo v2, "updateEditScenariosData findDifference:"

    invoke-static {v2, p1}, Lcoil/disk/a;->l(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v2

    sget-object v3, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->a:Ljava/lang/String;
    ...
    const-string/jumbo v0, "updateEditScenariosData emit "
...
.method public static e(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v8, v9, v3}, Lkotlin/text/StringsKt;->s(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget-object v8, v5, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->n:Landroid/net/Uri;

    invoke-static {v8}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v8

    iget-object v9, v6, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->n:Landroid/net/Uri;
    ...
    :cond_5
    invoke-static {}, Lkotlin/collections/CollectionsKt;->S()V
...
.method public static synthetic q(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;ZI)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->p(ZZ)Lkotlinx/coroutines/Job;
...
.method public final d(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->i()Landroid/content/Context;
    ...
    invoke-static {v4, v5}, Lcom/zeekr/scenario/customization/carditem/ext/ViewExtKt;->d(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-direct {v4, v2}, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;-><init>(Z)V
    ...
    iput-object v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->g:Ljava/lang/String;
    ...
    :goto_5
    iput-boolean v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->h:Z

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->getScenarioName()Ljava/lang/String;

    move-result-object v6

    iput-object v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->m:Ljava/lang/String;

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->getIcon()Lcom/zeekr/scenarioengine/service/operation/vo/ScenarioIconVo;

    move-result-object v6

    invoke-virtual {v6}, Lcom/zeekr/scenarioengine/service/operation/vo/ScenarioIconVo;->getNightLocalUri()Landroid/net/Uri;

    move-result-object v6

    iput-object v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->n:Landroid/net/Uri;

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->getIcon()Lcom/zeekr/scenarioengine/service/operation/vo/ScenarioIconVo;

    move-result-object v6

    invoke-virtual {v6}, Lcom/zeekr/scenarioengine/service/operation/vo/ScenarioIconVo;->getDayLocalUri()Landroid/net/Uri;

    move-result-object v6

    iput-object v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->o:Landroid/net/Uri;

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->isShortcut()Z

    move-result v6

    iput-boolean v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->j:Z

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->getExecuteType()I

    move-result v6

    iput v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->k:I

    invoke-virtual {v1}, Lcom/zeekr/scenarioengine/service/operation/vo/CustomizeScenarioVo;->getSort()J

    move-result-wide v6

    iput-wide v6, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->i:J

    iput-boolean v5, v4, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;->l:Z
...
.method public final f()Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final g(Ljava/util/List;ZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v0, v2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object v8, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;->f:Ljava/util/ArrayList;

    iget-object v9, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;->e:Ljava/lang/Object;

    check-cast v9, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;
    ...
    invoke-virtual {v0, v3}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->j(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v2, v11}, Lkotlin/collections/CollectionsKt;->m(Ljava/lang/Iterable;I)I
    ...
    :cond_8
    :goto_5
    check-cast v13, Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;
    ...
    invoke-static {v6}, Lcom/zeekr/scenario/customization/carditem/utils/SELog;->c(Ljava/lang/String;)V
    ...
    :cond_a
    invoke-static {v5}, Lkotlin/collections/CollectionsKt;->X(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {v8}, Lkotlin/collections/CollectionsKt;->W(Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;

    move-result-object v6

    invoke-interface {v6, v2}, Ljava/util/Collection;->removeAll(Ljava/util/Collection;)Z

    invoke-interface {v5, v6}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    const/4 v2, 0x4

    invoke-static {v5, v2}, Lkotlin/collections/CollectionsKt;->Q(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    iput-object v13, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;->f:Ljava/util/ArrayList;

    iput-object v13, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;->g:Ljava/util/ArrayList;

    const/4 v5, 0x2

    iput v5, v3, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCardItems$1;->k:I

    invoke-virtual {v9, v1, v3}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->o(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final i()Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->c:Ljava/lang/ref/WeakReference;
...
.method public final j(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$getCurAccountCardScenariosCodeToSp$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {v0}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;->h()Ljava/util/HashMap;
...
.method public final k()Lcom/zeekr/scenarioengine/service/operation/OperationServiceManager;
    .locals 1
...
.method public final l()Lcom/zeekr/scenario/customization/carditem/bean/CustomizeScenarioMetaData;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final m(Ljava/util/ArrayList;)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$saveCardScenarios$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Ljava/util/List;Lkotlin/coroutines/Continuation;)V

    const/4 p1, 0x2

    invoke-static {p0, v0, v2, v1, p1}, Lkotlinx/coroutines/BuildersKt;->c(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/CoroutineDispatcher;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/Job;
...
.method public final o(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$saveCardScenariosCodeToSp$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;Lkotlin/coroutines/Continuation;)V
...
.method public final p(ZZ)Lkotlinx/coroutines/Job;
    ...
    invoke-direct {v1, p0, p2, p1, v2}, Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager$updateAllData$1;-><init>(Lcom/zeekr/scenario/customization/carditem/CustomizeScenarioManager;ZZLkotlin/coroutines/Continuation;)V
