...
.method public static final e(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZ)I
    ...
    iget p3, p5, Lkotlin/ranges/IntProgression;->a:I

    iget v1, p5, Lkotlin/ranges/IntProgression;->c:I

    iget p5, p5, Lkotlin/ranges/IntProgression;->b:I
    ...
    invoke-static/range {v2 .. v7}, Lkotlin/text/StringsKt__StringsKt;->i(Ljava/lang/CharSequence;ILjava/lang/CharSequence;IIZ)Z
...
.method public static final f(ILjava/lang/CharSequence;Z[C)I
    .locals 7
    .param p1    # Ljava/lang/CharSequence;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :cond_1
    invoke-static {p1}, Lkotlin/text/StringsKt__StringsKt;->c(Ljava/lang/CharSequence;)I

    move-result v3

    invoke-direct {v1, p0, v3}, Lkotlin/ranges/IntRange;-><init>(II)V
    ...
    invoke-static {v6, v3, p2}, Lkotlin/text/CharsKt__CharKt;->b(CCZ)Z
...
.method public static final g(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    invoke-static {p0, v0, v1, v1}, Lkotlin/text/StringsKt__StringsKt;->h(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Lkotlin/sequences/Sequence;
...
.method public static h(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Lkotlin/sequences/Sequence;
    .locals 2

    invoke-static {p3}, Lkotlin/text/StringsKt__StringsKt;->j(I)V
    ...
    invoke-direct {v1, p2, p1}, Lkotlin/text/StringsKt__StringsKt$rangesDelimitedBy$2;-><init>(ZLjava/util/List;)V
...
.method public static final j(I)V
    ...
    invoke-static {v0, p0}, Landroid/car/content/pm/a;->f(Ljava/lang/String;I)Ljava/lang/String;
...
.method public static final k(ILjava/lang/CharSequence;Ljava/lang/String;Z)Ljava/util/List;
    .locals 7

    invoke-static {p0}, Lkotlin/text/StringsKt__StringsKt;->j(I)V

    const/4 v0, 0x0

    invoke-static {v0, p1, p2, p3}, Lkotlin/text/StringsKt__StringsKt;->d(ILjava/lang/CharSequence;Ljava/lang/String;Z)I
...
.method public static final m(Ljava/lang/CharSequence;Lkotlin/ranges/IntRange;)Ljava/lang/String;
    .locals 1
    .param p0    # Ljava/lang/CharSequence;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p1}, Lkotlin/ranges/IntRange;->e()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lkotlin/ranges/IntRange;->d()Ljava/lang/Integer;
